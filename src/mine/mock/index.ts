export const transactionEX = [
  ...
  // 대기중이던 거래에 대한 TX
  {
    txIns: [
      {
        txOutId:
          '3cd36d02eac329b0b181e7e9dfa2ed0c8e34a0e1a4443b9c90a7488c74af6fc5',
        txOutIndex: 0,
        sigature: {
    ...
    txOuts: [
      //66 계정은 30PTC 를 받음
      {
        account: '772d21d68e308d8b32a64431eddd5611c704w366',
        amount: 3000,
      },
      //49 계정은 50PTC UTXO 를 소진해서 20PTC 를 얻음
      {
        account: '993d21d68e308d8b32a64431eddd5611c704w366',
        amount: 2000,
      },
    ],
